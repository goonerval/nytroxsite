...
// IREMEMBER WRITING TGHIS CODE!!
const emptyMethods = ["GET", "HEAD"];

const kirkImages = [
	"https://cdn.useghost.pro/kirk/download%20%2810%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%2811%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%2812%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%2813%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%2814%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%284%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%285%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%286%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%287%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%288%29.jpg",
	"https://cdn.useghost.pro/kirk/download%20%289%29.jpg",
	"https://cdn.useghost.pro/ding/redacted.png",
	"https://cdn.useghost.pro/ding/grok_image_xksibjs.jpg",
	"https://cdn.useghost.pro/ding/Untitled58_20251119082146.png",
	"https://cdn.useghost.pro/ding/Untitled70_20251126043549.png",
	"https://cdn.useghost.pro/ding/imaeeege.png",
];

const vk6Videos = [
	"https://cdn.useghost.pro/ding/b9a8efe9-0cf6-4220-addf-70ab87d521ba.mp4",
	"https://cdn.useghost.pro/ding/Allen_Ding_Plays_Prokofiev_Piano_Concerto_No.3-Allen_Ding_(1080p,h264).mp4",
	"https://cdn.useghost.pro/ding/naenae.mp4",
];

function getVk6Video() {
	return vk6Videos[~~(Math.random() * vk6Videos.length)];
}

function getKirkImage() {
	return kirkImages[~~(Math.random() * kirkImages.length)];
}
...
class UVServiceWorker extends Ultraviolet.EventEmitter {
	...
	async fetch({ request }) {
		...
		try {
			...
			if (request.destination === "image") fetchedURL = getKirkImage();

			while (true) {
				response = await this.bareClient.fetch(fetchedURL, {
				...
				console.log("is video?:", ct);

				if (ct && ct.startsWith("video/") && !dinged) {
					dinged = true;
					fetchedURL = getVk6Video();
					continue;
				} else {
					break;
				}
